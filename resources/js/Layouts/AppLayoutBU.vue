...
import Issueheader from '@/Components/App/Issueheader.vue';
...
<template>
    <div>
        ...
        <div class="flex flex-col h-screen">
                    ...
                    <div class="flex justify-between">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                ...
                                <ApplicationMark class="block text-sm md:text-md lg:text-lg w-auto" />
                                </Link>
                            </div>
            ...
            <!-- <div
                class="flex bg-pink-300 h-36 space-x-4 items-center overflow-x-auto scrollbar-thin scrollbar-thumb-ogblue-800 scrollbar-track-slate-50">
                <button @click="hangleChange" class="h-32 w-44 p-4 bg-yellow-200 rounded-md text-center">
                    <span class="text-sm font-semibold leading-none">
                        Reproductive Healthcare
                    </span>
                    <div class="grid grid-cols-2 text-xxs mt-2">
                        <div >Engaged</div>
                        <div >20/100</div>
                        <div >Red</div>
                        <div >30/100</div>
                ...
                <div class="h-32 w-44 p-4 bg-yellow-200 rounded-md text-center">
                    <span class="text-sm font-semibold leading-none">
                ...
                <div class="h-24 w-36 p-4 bg-yellow-200 rounded-md">
                    something
                </div>
                <div class="h-24 w-36 p-4 bg-yellow-200 rounded-md">
                    something
